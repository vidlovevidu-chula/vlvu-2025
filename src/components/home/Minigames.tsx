    ...
    return (
        <div className="h-auto w-full flex flex-col items-center justify-center gap-4">
            ...
            <div className="text-center leading-tight flex flex-col gap-1 font-Ovo font-semibold">
                ...
                <a href="#" className="text-lg text-blackrose" onClick={() => alert('Coming soon!')}> Click to Play </a>
            </div>
            </div>
            ...
            <div className="text-center leading-tight flex flex-col gap-1 font-Ovo font-semibold">
                ...
                <a href="#" className="text-lg text-blackrose" onClick={() => alert('Coming soon!')}> Click to Create </a>
            </div>
            <img
            ...
            <div className="text-center leading-tight flex flex-col gap-1 font-Ovo font-semibold">
                ...
                <a href="#" className="text-lg text-blackrose" onClick={() => alert('Coming soon!')}> Click to Collect </a>
            </div>
            </div>
        </div>
    );
