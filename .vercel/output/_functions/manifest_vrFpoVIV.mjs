...
const manifest = deserializeManifest({
  hrefRoot: "file:///Users/user/Desktop/work/VLVU2025/",
  ...
  routes: [
    ...
    },
    {
      ...
      routeData: {
        ...
        segments: [
          ...
          [{ content: "example", dynamic: false, spread: false }],
        ],
        params: [],
        component: "src/pages/api/example/index.ts",
    ...
    },
    {
      ...
      routeData: {
        ...
        segments: [
          [{ content: "api", dynamic: false, spread: false }],
          [{ content: "stamp", dynamic: false, spread: false }],
        ],
        params: [],
        component: "src/pages/api/stamp.ts",
        pathname: "/api/stamp",
        prerender: false,
        fallbackRoutes: [],
        distURL: [],
    ...
    },
    {
      ...
      links: [],
      scripts: [],
      styles: [{ type: "external", src: "/_astro/game.DKnNW5Gf.css" }],
      routeData: {
        route: "/game",
        isIndex: false,
        type: "page",
        pattern: "^\\/game\\/?$",
        segments: [[{ content: "game", dynamic: false, spread: false }]],
        params: [],
        component: "src/pages/game.astro",
        pathname: "/game",
        prerender: false,
        fallbackRoutes: [],
        distURL: [],
  ...
  componentMetadata: [
    [
      "/Users/user/Desktop/work/VLVU2025/src/pages/game.astro",
      { propagation: "none", containsHead: true },
    ],
    [
      "/Users/user/Desktop/work/VLVU2025/src/pages/index.astro",
      { propagation: "none", containsHead: true },
    ],
  ],
  renderers: [],
  ...
  entryModules: {
    ...
    "\u0000@astro-page:src/pages/api/example/index@_@ts":
      "pages/api/example.astro.mjs",
    "\u0000@astro-page:src/pages/api/stamp@_@ts": "pages/api/stamp.astro.mjs",
    "\u0000@astro-page:src/pages/game@_@astro": "pages/game.astro.mjs",
    "\u0000@astrojs-ssr-virtual-entry": "entry.mjs",
    "\u0000@astro-page:src/pages/index@_@astro": "pages/index.astro.mjs",
    "\u0000@astro-renderers": "renderers.mjs",
    "\u0000@astro-page:node_modules/.pnpm/astro@5.1.10_@types+node@22.10.7_jiti@1.21.7_rollup@4.31.0_typescript@5.7.3_yaml@2.7.0/node_modules/astro/dist/assets/endpoint/generic@_@js":
      "pages/_image.astro.mjs",
    "/Users/user/Desktop/work/VLVU2025/node_modules/.pnpm/astro@5.1.10_@types+node@22.10.7_jiti@1.21.7_rollup@4.31.0_typescript@5.7.3_yaml@2.7.0/node_modules/astro/dist/assets/services/sharp.js":
      "chunks/sharp_BYpgJSzI.mjs",
    "\u0000@astrojs-manifest": "manifest_vrFpoVIV.mjs",
    "@astrojs/react/client.js": "_astro/client.BNC2RHkt.js",
    "astro:scripts/before-hydration.js": "",
  },
  inlinedScripts: [],
  assets: [
    "/_astro/game.DKnNW5Gf.css",
    "/favicon.svg",
    "/_astro/client.BNC2RHkt.js",
    "/fonts/AtsaneeDEMO-Thin.otf",
    "/fonts/RibbonDemo-Regular.ttf",
    "/fonts/YesevaOne-Regular.ttf",
  ],
